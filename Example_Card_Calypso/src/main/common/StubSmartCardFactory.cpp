...
#include "StubSmartCardFactory.hpp"
...
const std::string StubSmartCardFactory::CARD_POWER_ON_DATA
    = "3B888001000000009171710098";
const std::string StubSmartCardFactory::SAM_POWER_ON_DATA
    = "3B3F9600805A0080C120000012345678829000";
const std::string StubSmartCardFactory::ISO_CARD_PROTOCOL = "ISO_14443_4_CARD";
const std::string StubSmartCardFactory::SAM_PROTOCOL = "ISO_7816_3_T0";
...
std::shared_ptr<StubSmartCard> StubSmartCardFactory::mStubCard
    = StubSmartCard::builder()
          ...
          .withSimulatedCommand(
              ...
              "6F238409315449432E49434131A516BF0C13C70800000000AABBCCDD53070A3C"
              "23051410019000")
          /* Read records */
          .withSimulatedCommand(
              "00B2013C00",
          ...
          .withSimulatedCommand(
              ...
              "0308D1810030791D00112233445566778899AABBCCDDEEFF0011223344556677"
              "8899AABBCC9000")
...
StubSmartCardFactory::getStubCard() {
    return mStubCard;
}

std::shared_ptr<StubSmartCard>
StubSmartCardFactory::getStubSam() {
    return mStubSam;
}
